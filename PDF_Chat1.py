...
def retrieve_answer_LLM(docs,query):
    p_template = '''
    Based on the provided context, answer the following question as thoroughly and accurately as possible. Ensure that your answer is detailed and well-explained. If the information needed to answer the question is not present in the context, respond with "The answer is not available in the context." Avoid providing incorrect information.
